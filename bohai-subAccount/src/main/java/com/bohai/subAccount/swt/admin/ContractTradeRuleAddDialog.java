...
public class ContractTradeRuleAddDialog extends Dialog {
	 ...
	 */
	public ContractTradeRuleAddDialog(Shell parent, int style, MainForm mainForm) {
        super(parent, style);
        setText("添加合约交易限制");
