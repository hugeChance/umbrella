...
//            if(coreappView.getCtpFirst() == null){
////            	coreappView.recreateSocket();
//                try {
//                    //若果连不到行情服务器，每隔两秒尝试一次
//                	logger.info("若果连不到CTP前置机，每隔1秒尝试一次");
//                    Thread.sleep(5000);
...
//                
//            } catch (Exception e) {
//                logger.error("获取CTPsocket输入流失败",e);
//                try {
////                	coreappView.recreateSocket();
//                    Thread.sleep(5000);
//                    
...
//            }
	...
	//                        pInputOrder.setMinVolume(json1.getString("minVolume"));
	                    ...
	                    logger.error("获取CTP前置机SOCKET输入流失败",e);
